...
import com.jobapp.companyms.client.JobClient;
...
public class JobClientServiceImpl implements JobClientService {
    ...
    public void deleteJobsByCompany(Long id) {
        jobClient.deleteJobByCompany(id);
    }
    ...
    public boolean isAvailable() {
        try {
            ...
            //FeignException , Timeout,Connection refused,etc.
            return false;
        }
    }
    ...
    public void deleteJobFallback(Long companyId, Throwable throwable) {
        logger.error("Job service unavailable. Unable to delete jobs for companyId: {} ", companyId, throwable);
